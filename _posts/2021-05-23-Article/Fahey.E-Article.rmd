...
```{r appendix play, include=FALSE}

# HAVE A LOOK AT THIS

#appendix = TRUE on certain code chunks, and ref.label = knitr::all_labels(appendix == TRUE)
...
**Reasons to visit a place scale**
