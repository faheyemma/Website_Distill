...
surname: Fahey
position: "Advisor"
email: "faheyemma@myvuw.ac.nz"
date: "`r format(Sys.time(), '%B %Y')`"
aboutme: "Emma is a governmetnal advisor currently completing psyhcology honours at Victoria Universtiy of Wellington."
output: 
  vitae::moderncv:
    theme: casual
---
...
tribble(
  ...
  "Bachelor of Science (honours)", "in progress", "Psychology", "Victoria University of Wellington",
  "Bachelor of Science", "2015-2018", "Ecology, Biodiversity and Psychology", "Wellington, New Zealand",
) %>% 
